...
#    Updated: 2017/01/27 17:07:12 by mc               ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
if [ "$FILE_SIZE" = 0 ]; then
    echo -e "\033[37;01mTesting header \033[32;01mOK\033[0m";
else
    echo -e "\033[37;01mTesting header \033[31;01mKO\033[0m";
    cat header_test;
fi
rm header_test;
echo "";
...
if [ $AUTEUR = $AUTEUR_TEST ]; then
    echo -e "\033[37;01mTesting auteur \033[32;01mOK\033[0m";
else
    echo -e "\033[37;01mTesting auteur \033[31;01mKO\033[0m";
    cat -e auteur;
fi
rm auteur_test;
echo "";
...
if [ "$FILE_SIZE" = 0 ]; then
    echo -e "\033[37;01mTesting temp files \033[32;01mOK\033[0m";
else
    echo -e "\033[37;01mTesting temp files \033[31;01mKO\033[0m";
    cat tmp_test;
fi
rm ls_test;
rm tmp_test;
...
if [ "$FILE_SIZE" = 0 ]; then
    echo -e "\033[37;01mTesting norme \033[32;01mOK\033[0m";
else
    echo -e "\033[37;01mTesting norme \033[31;01mKO\033[0m";

...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (go-mode highlight-indentation origami rjsx-mode slime csv-mode jsx-mode dockerfile-mode autodisass-llvm-bitcode sass-mode json-mode inf-ruby yaml-mode web-mode utop use-package tuareg smex rainbow-delimiters projectile php-mode php-eldoc markdown-mode magit ledger-mode keyfreq js2-mode ido-grid-mode ido-completing-read+ ido-complete-space-or-hyphen highlight-numbers gtags git-timemachine ggtags flycheck-ocaml flycheck-ledger flycheck-cython flx-ido emms diminish diff-hl cython-mode company-statistics benchmark-init ace-window))))
